...
class OrderTransactionsControllerTest < ActionController::TestCase
  ...
  test "should create order_transaction" do
    assert_difference('OrderTransaction.count') do
      post :create, order_transaction: { action: @order_transaction.action, amount: @order_transaction.amount, authorization: @order_transaction.authorization, message: @order_transaction.message, params: @order_transaction.params, success: @order_transaction.success }
    end
  ...
  test "should update order_transaction" do
    put :update, id: @order_transaction, order_transaction: { action: @order_transaction.action, amount: @order_transaction.amount, authorization: @order_transaction.authorization, message: @order_transaction.message, params: @order_transaction.params, success: @order_transaction.success }
    assert_redirected_to order_transaction_path(assigns(:order_transaction))
  end
